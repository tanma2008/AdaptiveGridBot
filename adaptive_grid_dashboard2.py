...
ACCOUNTS = [
    ...
    {"key": "D", "name": "v4.8", "env": ".env", "prefix": "ETHv048", "symbol": "ETH-USDT"},
    {"key": "E", "name": "v4.9", "env": ".env.v49", "prefix": "ETHv049", "symbol": "ETH-USDT"},
    {"key": "F", "name": "v5.1.1", "env": ".env.v50", "prefix": "F511", "symbol": "ETH-USDT"},
    {"key": "G", "name": "v4.8", "env": ".env", "prefix": "", "symbol": "SOL-USDT", "all_symbol_orders": True},
    {"key": "H", "name": "v4.9", "env": ".env.v49", "prefix": "", "symbol": "SOL-USDT", "all_symbol_orders": True},
    {"key": "I", "name": "v5.1.1", "env": ".env.v50", "prefix": "", "symbol": "SOL-USDT", "all_symbol_orders": True},
]
...
def get_open_orders(account):
    try:
        ...
        # Each dashboard account is isolated by its env file + symbol.
        # Use all open orders for that symbol so every bot A-I is measured consistently.
        bot = rows
