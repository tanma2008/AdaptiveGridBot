...
# ============================================================
# ADAPTIVE GRID BOT v4.6 RISK REPORT
...
def main():
    ...
    print()
    print("=" * 78)
    print("        ADAPTIVE GRID BOT v4.6 RISK REPORT")
    ...
    result["curve"].to_csv(
        "backtest_v046_equity.csv",
        index=False,
    )

    result["regimes"].to_csv(
        "backtest_v046_regimes.csv",
        index=False,
    )

    result["trades"].to_csv(
        "backtest_v046_trades.csv",
        index=False,
    )

    segments.to_csv(
        "backtest_v046_segments.csv",
        index=False,
    )
    ...
    print()
    print("Saved:")
    print("  backtest_v046_equity.csv")
    print("  backtest_v046_regimes.csv")
    print("  backtest_v046_trades.csv")
    print("  backtest_v046_segments.csv")

    print()
    print("=" * 78)
    print("              V4.6 RISK REPORT COMPLETE")
    print("=" * 78)
    print()
