...
def get_target_grid():
    ...
    """
    Calculate the target grid using the SAME v4.8 strategy
    functions already present in this file.

    No exchange orders are created or cancelled here.
    """
