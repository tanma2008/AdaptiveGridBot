...
import pandas as pd
from eth_backtest_v048 import run_backtest
...
def validate():
    ...
    checks = {
        ...
        'equity_consistent': abs((Decimal('1000') + r['realized'] + r['unrealized']) - r['equity']) < Decimal('0.00001'),
        'fees_positive_or_zero': r['fees'] >= 0,
        'inventory_nonnegative': r['inventory'] >= 0,
        'cycles_consistent': r['cycles'] == r['wins'] + r['losses'],
    }
    print('=' * 76)
    print('ETH-USDT v4.8 | BACKTEST VALIDATION')
