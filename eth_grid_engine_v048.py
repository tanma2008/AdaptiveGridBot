...
FILE_1H = "eth_usdt_1h.csv"
FILE_1D = "eth_usdt_1d.csv"
ATR_MULTIPLIER = 0.3
GRID_LEVELS_UP = 3
GRID_LEVELS_DOWN = 5
...
def main():
    print("=" * 76)
    print("        ADAPTIVE GRID BOT v4.8 - ETH/USDT")
    ...
    print()
    print("ETH v4.8 RISK ENGINE: PASS" if risk["status"] == "PASS" else "ETH v4.8 RISK ENGINE: BLOCK")
